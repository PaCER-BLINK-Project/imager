...
//   double GetStartDateMJD() const;
   ...
   bool fix_metafits( double obsid, double inttime_sec=1.00, bool bChangePhaseCentre=false, double external_ra_deg=-1000, double external_dec_deg=-1000 ); // OBSID is in fact GPS time
