...
echo "./pacer_imager_multi 20221216_101030_test_100ms_ch124 -f 96.875 -n 180 -N 1 -G -Z -v 200 -B 1 -o save_imag"
./pacer_imager_multi 20221216_101030_test_100ms_ch124 -f 96.875 -n 180 -N 1 -G -Z -v 200 -B 1 -o save_imag

# first_sky_re=gpumulti_dirty_image_ch000_real.fits
# first_sky_im=gpumulti_dirty_image_ch000_imag.fits
first_sky_re="ch00000/gpumulti_dirty_image_ch000_20221216T101030000_real.fits"
first_sky_im="ch00000/gpumulti_dirty_image_ch000_20221216T101030000_imag.fits"
