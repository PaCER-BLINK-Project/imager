...
def find_value_reim( value_re, value_im, data_re, data_im, x_size, y_size, allow_conjugate=True ) :
   if allow_conjugate : 
   ...
   for x in range(0,x_size) : # step of 2 floats to save RE/IM :
      for y in range(0,y_size ):
         ...
         if math.fabs(value_re-val_re) < 0.0000001 and math.fabs(value_im-val_im) < 0.0000001 : 
            # print("FOUND %.20f at (%d,%d) = %.20f (next imaginary value is zero %s)" % (value,x,y,gpu_val,im_ok))
...
debug=0
# fitsname="re.fits"
fitsname_x_re = "1276619416_20200619163000_vis_real_channel000_time000000_pol01.fits"
fitsname_x_im = "1276619416_20200619163000_vis_imag_channel000_time000000_pol01.fits"

fitsname_y_re = "1276619416_20200619163000_vis_real_channel000_time000000_pol02.fits"
fitsname_y_im = "1276619416_20200619163000_vis_imag_channel000_time000000_pol02.fits"
