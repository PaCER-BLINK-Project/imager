...
# -usepcentre
cotter -noalign -absmem 64 -j 12 -timeres 1 -freqres 0.01 -edgewidth 0 -noflagautos -m 20200619163000.metafits -noflagmissings -allowmissing -offline-gpubox-format -initflag 0 -o 1276619416_20200619163000.ms  -nocablelength -nogeom -norfi -noantennapruning -nosbgains -noflagdcchannels -sbpassband subband-passband-32ch-unitary.txt 1276619416_20200619163000*gpubox*.fits
